  ...
  $(document).ready(function () {
    ...
    $("#pricing-save").on("click", function (f) {
      ...
      $("#pricing-table .pricing-price").each(function (m, h) {
        ...
        var bs = r.find("input.pricing-booking-fees-number").val();
        ...
        if (bs.match(/^[0-9]+$/)) {
          ...
          if (!bs.match(/^[0-9]+,[0-9][0-9]$/)) {
            window.alert(
              'Hinweis: Der Preis "' + bs + '" ist ungültig - Format: 19,95'
            );
            f.preventDefault();
            return;
          }
        ...
        var w = JSON.stringify([k, v, n, y, o, p, z, j, t, bs, x, q, i, g]);
    ...
    $.each(d, function (k, g) {
      ...
      if (lol >= 100) {
        lol = lol.substring(0, lol.length - 2) + "," + lol.substring(lol.length - 2);
      } else {
        if (lol >= 10) {
          lol = "0," + lol;
        } else {
      ...
      $("#pricing-table .pricing-booking-fees-number:last").val(lol);
